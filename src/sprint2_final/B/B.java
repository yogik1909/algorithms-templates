...
На каждую операцию будет приходиться 2 доп извелечения и одно помещение занчений
 ...
 ~~ Посторил свое предположение на ряди з 2-х и 3-х оперциях в первом случае будет 5 операций во втором 9 ~~
 ~~ Если будет мат операций будет уже 4 сложность возрастет до 12 операций т. е. +4 оперции от плошной~~
 В самомм худшем варианте вычислительная сложность будет линейно асимптоматична O(N)
