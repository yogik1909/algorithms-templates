...
Так же отдельно я обработал несоклько пограничных случаев
 - когда массив отсбортирвоан от начала до конча, в этом случае нет необходисомти искать границу полуинтервала
 - когда в массиве 0, 1, 2 элеметов
    - в случе с путным массивом нет необзодисомти проверять нахождение искомого числа
    - в случае включения единствного чилса достаточно сравнить его с искомым числом
    - в случа 2 элементво достаточно поправно сравунить знаяния элементво массива с искомым числом
